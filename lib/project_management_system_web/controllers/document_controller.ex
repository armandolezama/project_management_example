defmodule ProjectManagementSystemWeb.DocumentController do
  use ProjectManagementSystemWeb, :controller

  alias ProjectManagementSystem.Management
  alias ProjectManagementSystem.Management.Document

  action_fallback ProjectManagementSystemWeb.FallbackController
